...
// نفس المقالات الافتراضية
const DEFAULT_POSTS: Record<string, any> = {
  'building-sports-team': {
...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      console.log('Backend unavailable for post:', postId)
    }

    // استخدم البيانات الافتراضية
    const post = DEFAULT_POSTS[postId]
