      ...
      <div className="relative z-10">
        ...
        <section className="py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <div className="bg-white rounded-2xl p-2 inline-flex shadow-lg border border-gray-100">
                <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {jobCategories.map((category, index) => (
                <motion.div
                  ...
                  className={`bg-gradient-to-r ${category.color} rounded-3xl p-8 text-white cursor-pointer hover:shadow-2xl transition-all duration-300 relative overflow-hidden`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                  className="bg-white border border-gray-100 rounded-3xl p-8 text-center hover:shadow-2xl transition-all duration-300 group"
                >
                  <div
