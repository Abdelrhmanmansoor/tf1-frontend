...
import type { Privacy, UpdatePrivacyData } from '@/types/player'
...
const PrivacySettingsPage = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      await playerService.updatePrivacy(privacy)
        ...
        >
          ...
          <div className="p-6 space-y-4">
            <label
              ...
              privacy.profileVisibility === 'public' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
            }"
            >
              <input
                type="radio"
            ...
            <label
              className={`flex items-start gap-4 p-4 border-2 rounded-xl cursor-pointer transition hover:bg-gray-50 ${
                privacy.profileVisibility === 'clubs_only'
            ...
            >
              <input
                ...
                name="visibility"
                value="clubs_only"
                checked={privacy.profileVisibility === 'clubs_only'}
                onChange={(e) =>
                  setPrivacy({ ...privacy, profileVisibility: 'clubs_only' })
                }
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-bold text-gray-900">
                    {language === 'ar'
                      ? 'الأندية والمدربون فقط'
                      : 'Clubs & Coaches Only'}
                  </span>
                </div>
                <p className="text-sm text-gray-600">
                  {language === 'ar'
                    ? 'يمكن للأندية والمدربين المسجلين فقط رؤية ملفك'
                    : 'Only registered clubs and coaches can see your profile'}
                </p>
              </div>
            </label>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  {language === 'ar'
                    ? 'يمكن لجهات الاتصال الخاصة بك فقط رؤية ملفك'
              ...
              <label className="flex items-center justify-between cursor-pointer">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      setPrivacy({ ...privacy, showContact: e.target.checked })
                    }
              ...
              <label className="flex items-center justify-between cursor-pointer">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      setPrivacy({ ...privacy, showSalary: e.target.checked })
                    }
                    className="sr-only peer"
                  />
